...
public class WatchlistController {
    ...
    public ResponseEntity<PageResponse<WatchlistItemResponse>> getWatchlist(
        ...
        return ResponseEntity.ok(watchlistService.getWatchlist(userId, SORT_WHITELIST.sanitize(pageable)));
    }
    ...
    public ResponseEntity<WatchlistItemResponse> addToWatchlist(@AuthenticatedUser UUID userId,
        ...
        WatchlistItemResponse created = watchlistService.addToWatchlist(userId, addToWatchlist);
